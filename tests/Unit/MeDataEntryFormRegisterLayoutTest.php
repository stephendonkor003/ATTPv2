...
it('keeps every data-entry register separated and displays the linked indicator', function () {
    ...
    expect($view)
        ...
        ->toContain('Preview form')
        ->toContain('data-preview-form')
        ->toContain('data-form-preview-modal')
        ->toContain('data-form-preview-data')
        ->toContain('openFormPreview')
        ->toContain('Instructions for the respondent')
