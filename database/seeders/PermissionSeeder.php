...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            ['name' => 'news.manage', 'module' => 'communications', 'description' => 'Create and manage ATTP news posts and downloadable attachments'],
            ['name' => 'news.approve', 'module' => 'communications', 'description' => 'Approve and publish ATTP news posts'],
            ...
            ['name' => 'me.framework.manage', 'module' => 'M&E', 'description' => 'Manage controlled ATTP Results Framework versions and Indicator Reference Sheets'],
            ['name' => 'me.targets.manage', 'module' => 'M&E', 'description' => 'Manage project and Think Tank indicator target allocations and revisions'],
            ['name' => 'me.submissions.review', 'module' => 'M&E', 'description' => 'Review, verify, return, approve, or reject M&E submissions'],
            ['name' => 'me.results.view', 'module' => 'M&E', 'description' => 'View approved-only official ATTP MEL results'],
            ['name' => 'me.reports.export', 'module' => 'M&E', 'description' => 'Export official ATTP MEL reports'],
            ['name' => 'me.dqa.manage', 'module' => 'M&E', 'description' => 'Review and resolve M&E data-quality findings'],
            ['name' => 'me.performance_reports.view', 'module' => 'M&E', 'description' => 'View performance reports across the assigned M&E portfolio'],
            ['name' => 'me.performance_reports.review', 'module' => 'M&E', 'description' => 'Review, approve, or return submitted performance reports'],
            ['name' => 'me.performance_reports.archive', 'module' => 'M&E', 'description' => 'Archive reviewed performance reports as historical records'],
            ['name' => 'me.mission_reports.view', 'module' => 'M&E', 'description' => 'View standardized M&E mission reports'],
            ['name' => 'me.mission_reports.manage', 'module' => 'M&E', 'description' => 'Create and update M&E mission reports'],
            ['name' => 'me.mission_reports.review', 'module' => 'M&E', 'description' => 'Review, approve, or return M&E mission reports'],
            ['name' => 'me.mission_reports.archive', 'module' => 'M&E', 'description' => 'Archive approved M&E mission reports'],
            ['name' => 'me.reporting_notifications.view', 'module' => 'M&E', 'description' => 'View M&E reporting notifications and reminders'],
