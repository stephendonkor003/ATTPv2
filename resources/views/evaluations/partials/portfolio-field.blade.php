...
<div class="mb-3">
    ...
    @if ($portfolioFieldLocked && $selectedPortfolio)
        ...
        <small class="text-muted">This evaluation template is tied to your assigned portfolio.</small>
    @else
        ...
        <small class="text-muted">Evaluation templates are portfolio-specific and cannot be shared globally.</small>
    @endif
