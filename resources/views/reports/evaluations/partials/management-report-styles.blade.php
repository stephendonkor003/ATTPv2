<style>
    ...
    .eval-download-panel { background: #f8fbfc; border: 1px solid var(--eval-border); border-radius: 14px; margin: 18px 0 24px; overflow: hidden; }
    .eval-download-panel__head { align-items: flex-start; display: flex; gap: 18px; justify-content: space-between; padding: 18px 20px; }
    .eval-download-panel__head h3 { color: var(--eval-ink); font-size: 1rem; margin: 4px 0; }
    .eval-download-panel__head p { color: var(--eval-muted); font-size: .76rem; line-height: 1.55; margin: 0; }
    .eval-download-panel__badge { align-items: center; background: #e8f5f1; border: 1px solid #c6e6dc; border-radius: 999px; color: #0f6b5e; display: inline-flex; flex: 0 0 auto; font-size: .68rem; font-weight: 800; gap: 6px; padding: 7px 10px; }
    .eval-download-table td:last-child { min-width: 245px; }
    .eval-record-actions { display: flex; flex-wrap: wrap; gap: 7px; }
    .eval-record-action { align-items: center; background: #fff; border: 1px solid #b9cbd4; border-radius: 7px; color: #345464; display: inline-flex; font-size: .68rem; font-weight: 800; gap: 5px; padding: 7px 9px; text-decoration: none; white-space: nowrap; }
    .eval-record-action:hover { border-color: #0f766e; color: #0f766e; }
    .eval-record-action--primary { background: #0f766e; border-color: #0f766e; color: #fff; }
    .eval-record-action--primary:hover { background: #0b5f59; color: #fff; }
    ...
    @media (max-width: 767px) { .eval-nav { grid-template-columns: repeat(2, minmax(0, 1fr)); } .eval-section-head, .eval-section-body { padding: 21px 18px; } .eval-stat-grid, .eval-time-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); } .eval-insight-grid, .eval-governance-grid { grid-template-columns: 1fr; } .eval-record-head { grid-template-columns: 1fr; gap: 13px; } .eval-group-head, .eval-download-panel__head { flex-direction: column; gap: 8px; } .eval-chart-card { padding: 14px; } .eval-section-icon { display: none; } .eval-stat { padding: 15px; } .eval-stat strong { font-size: 1.7rem; } }
