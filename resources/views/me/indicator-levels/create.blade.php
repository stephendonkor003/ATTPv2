@extends('layouts.app')
@section('title', 'Create Indicator Level')
        ...
        <div class="page-header d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="fw-bold mb-1">
                    ...
                    Create Indicator Level
                </h4>
                <p class="text-muted mb-0">Add a new level to the M&E hierarchy.</p>
            </div>
        </div>
                ...
                <form action="{{ route('budget.me-configuration.indicator-levels.store') }}" method="POST" class="row g-3">
                    ...
                    <div class="col-12 d-flex justify-content-end gap-2">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="feather-save me-1"></i> Save Level
                        </button>
                    </div>
                </form>
            </div>
