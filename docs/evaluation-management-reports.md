...
- Charts place applicant submission codes on the horizontal axis and scores on the vertical axis. Codes map to applicant names in the adjacent tables. Colours identify evaluators. Lines compare applicants and do not imply time trends. Pies represent counts, not award probabilities.
